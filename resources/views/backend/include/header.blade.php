...
<!-- Mirrored from thememakker.com/swift/hospital/add-payments.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Nov 2017 16:54:37 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="active open"><a href="{{url('/root/dashboard')}}"><i class="zmdi zmdi-home"></i><span>Admin Dashboard</span></a></li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Product</span> </a>
                    <ul class="ml-menu">
                        <li><a href="{{url('product-create')}}">ADD</a></li>
                        <li><a href="{{url('product-view')}}">View</a></li>
                    </ul>
                </li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Category</span> </a>
                    <ul class="ml-menu">
                        <li><a href="{{url('category-create')}}">ADD</a></li>
                        <li><a href="{{url('category-view')}}">View</a></li>
                    </ul>
                </li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Orders</span> </a>
                    <ul class="ml-menu">
                        <li><a href="{{url('orders-pending')}}">Pending Orders</a></li>
                        <li><a href="{{url('orders-delivered')}}">Delivered Orders</a></li>
                        <li><a href="{{url('orders-all')}}">All Orders</a></li>
                    </ul>
                </li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Manage Suppliers</span> </a>
                    <ul class="ml-menu">
                        <li><a href="{{url('/root/dashboard')}}">View</a></li>

                    </ul>
                </li>
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Brands</span> </a>
                    <ul class="ml-menu">
                        <li><a href="{{url('brand-create')}}">ADD</a></li>
                        <li><a href="{{url('brands-view')}}">View</a></li>
                    </ul>
                </li>
            </ul>
        </div>
