                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-2 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" value="{{ old('price')}}"  name="price" class="form-control" placeholder="Product Price">
                                        </div>
                                        @if ($errors->has('price'))
                                            <span class="text-danger">
                                ...
                                <div class="col-sm-2 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" value="{{ old('quantity')}}" name="quantity" class="form-control" placeholder="Product Quantity">
                                        </div>
                                ...
                                <div class="col-sm-2 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" value="{{ old('product_id')}}" name="product_id" class="form-control" placeholder="Product ID">
                                        </div>
                                ...
                                <div class="col-sm-2 col-xs-12 m-t-30">
